...
const ProjectCard = ({ projName, link, logo, projLang }: ProjProps) => {
    return (
        <motion.a whileTap={{ scale: 0.9 }} key={projName} href={link} className='flex text-center justify-center align-middle place-items-center lg:justify-start lg:text-left'>
